...
class Kartikmodel2 {
  ...
  Kartikmodel2({this.id, this.name, this.username, this.email, this.address, this.phone, this.website, this.company});

  Kartikmodel2.fromJson(Map<String, dynamic> json) {
    if(json["id"] is int) {
      id = json["id"];
    }
